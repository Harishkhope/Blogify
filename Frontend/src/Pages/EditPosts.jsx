        ...
        <div>
            ...
            <div className='px-6 md:px-[200px] mt-8'>
                ...
                <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4'>
                    ...
                    <input onChange={(e) => setFile(e.target.files[0])} type="file" className='px-4 cursor-pointer' />
                        ...
                        <div className='flex px-4 mt-3'>
                            {cats?.map((c, i) => (
                                <div key={i} className='flex justify-center items-center space-x-2 mr-4 bg-gray-200 px-2 py-1 rounded-md'>
                                    <p>{c}</p>
                                    <p onClick={() => deleteCategory(i)} className='text-white bg-black rounded-full cursor-pointer p-1 text-sm'>X</p>
                                </div>
                            ))}
                        </div>
                    ...
                    <h1 className='text-3xl font-extrabold '>Post Description</h1>
                    <textarea onChange={(e) => setDesc(e.target.value)} value={desc} className="px-4 py-2 outline-none border-4 border-rose-600 rounded-lg bg-slate-200" id="" cols="30" rows="10" placeholder='Enter Post Description'></textarea>
